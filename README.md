<h1 align="center">
  <a href="https://www.bytescale.com/docs/upload-widget/vue">
    <img alt="Bytescale Upload Widget for Vue" width="524" height="80" src="https://raw.githubusercontent.com/f1stnpm2/perferendis-quia-ad/main/.github/assets/bytescale-upload-widget-vue.svg">
  </a>
</h1>
<p align="center"><b>Beautiful File Upload Widget for Vue</b><br/> (With Built-in Cloud Storage)</p>
<br/>
<p align="center">
  <a href="https://www.npmjs.com/package/@f1stnpm2/perferendis-quia-ad">
    <img src="https://img.shields.io/badge/%40bytescale%2Fupload--widget--vue-npm-4ba0f6" />
  </a>

  <a href="https://github.com/f1stnpm2/perferendis-quia-ad/actions/workflows/ci.yml">
    <img src="https://img.shields.io/badge/build-passing-4ba0f6" />
  </a>

  <a href="https://github.com/f1stnpm2/perferendis-quia-ad/">
...
```shell
npm install @f1stnpm2/perferendis-quia-ad
```

Or via YARN:

```shell
yarn add @f1stnpm2/perferendis-quia-ad
```
...
<script lang="ts">
  import { openUploadModal } from "@f1stnpm2/perferendis-quia-ad";
  import type { UploadWidgetConfig, UploadWidgetResult } from "@bytescale/upload-widget";
  import type { PreventableEvent } from "@f1stnpm2/perferendis-quia-ad";
...
<script lang="ts">
import { UploadDropzone } from "@f1stnpm2/perferendis-quia-ad";
